const en = {
    ...
    voiceMicBlocked: "Microphone is blocked for this site — click the lock/icon in the address bar and allow microphone access",
...
const ru = {
    ...
    voiceMicBlocked: "Микрофон заблокирован для этого сайта — нажмите на замок/иконку в адресной строке и разрешите доступ к микрофону",
