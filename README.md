...
│
├── 📂 screenshots/
│   ├── 📄 auth.png                      # Скриншот интерфейса регистрации/авторизации
│   ├── 📄 chat.png                      # Скриншот основного окна чата с сообщениями
│   ├── 📄 rooms.png                     # Скриншот управления комнатами (список, создание, вход)
│   └── 📄 users.png                     # Скриншот панели пользователей или администрирования
│
├── 📂 src/
│   ├── 📂 static/
